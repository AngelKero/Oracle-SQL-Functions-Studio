 ...
 * Standardized 24x24 stroke-based icons (Lucide / Feather style).
 */
...
export const SVG_PATHS = {
  ...
  calculator: '<rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" x2="16" y1="6" y2="6"/><line x1="16" x2="16" y1="14" y2="14"/><path d="M16 10h.01"/><path d="M12 10h.01"/><path d="M8 10h.01"/><path d="M12 14h.01"/><path d="M8 14h.01"/><path d="M12 18h.01"/><path d="M8 18h.01"/>',
 ...
 */
export function getIcon(name, className = 'svg-icon', size = 20) {
  const camelName = name.replace(/-([a-z0-9])/g, (_, ch) => ch.toUpperCase());
  const content = SVG_PATHS[name] || SVG_PATHS[camelName] || SVG_PATHS.zap;
